...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert "login" in self.browser.current_url, "It is not a login url"
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.PASSWORD_CONFIRM_REGISTER_FORM).send_keys(password)
